...
public class Login extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        userButton = findViewById(R.id.user_selector_2);
        merchantButton = findViewById(R.id.merchant_selector_2);
                                ...
                                if(userButton.isChecked()){
                                    ...
                                    ref.child(Objects.requireNonNull(mFirebaseAuth.getUid())).addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            if(dataSnapshot.exists()){
                                                Toast.makeText(Login.this, "Logged in!", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(Login.this, merchant_landing_page.class));
                                                finish();
                                            } else{
